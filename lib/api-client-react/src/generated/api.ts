 ...
 */
export const analyzeStock = async (analyzeInput: AnalyzeInput, options?: Parameters<typeof customFetch>[1]): Promise<StockAnalysis> => {
...
export const getAnalyzeStockMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof analyzeStock>>, TError,{data: BodyType<AnalyzeInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof analyzeStock>>, TError,{data: BodyType<AnalyzeInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof analyzeStock>>, {data: BodyType<AnalyzeInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AnalyzeStockMutationBody = BodyType<AnalyzeInput>
    export type AnalyzeStockMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Analyze a stock for swing trading
 */
export const useAnalyzeStock = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof analyzeStock>>, TError,{data: BodyType<AnalyzeInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
